...
<div id="page" class="site">
  ...
  <header id="masthead" class="site-header">
    ...
    <div id="header-wrap">
      ...
      <div id="actionbar">
        <? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "topbar.html"); ?>
      </div>
      ...
      <nav class="navbar">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "logo.html"); ?>
          ...
          <div class="collapse navbar-collapse" id="secondary-navigation-wrap">
            <ul id="secondary-menu" class="nav navbar-nav navbar-right">
              <li class="hb"><? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "hb.html"); ?></li>
        ...
        <div id="primary-navigation-container" class="menu-background-right ">
          ...
          <div class="container boxed-no-gutter">
            ...
            <div class="collapse navbar-collapse" id="primary-menu-wrap">
              <? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "nav.html"); ?>
            </div><!-- .navbar-collapse -->
          </div><!-- .container -->
    ...
    <main id="main" class="site-main" >
      ...
      <p><strong>When we receive your request for membership, we will send you a membership packet that will include a membership application and any pertinent credit union disclosure information.</strong></p>
		  <p><label for="001_MEMBER">MEMBER</label> <INPUT type="text" name="001_MEMBER" id="001_MEMBER" size="45"></p>
			  <p><label for="001_PHONE">PHONE</label> <INPUT type="text" name="001_PHONE" id="001_PHONE" size="45"></p>
      ...
      <p align="center"><INPUT type="reset" name="Reset" value="Reset ">&nbsp;&nbsp;<input type="submit" name="Submit" value="Submit">&nbsp;&nbsp;<script language="JavaScript"><!--if (window.print)
    document.write('<FORM><INPUT TYPE="BUTTON" VALUE="Print" onClick="myPrint()"><\/FORM>');//--></script></p>
      </form>
  ...
  <footer id="footer" class="site-footer" >
    ...
    <div id="footer-widget-container">
     <? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "footer1.html"); ?> 
    </div>

    <div id="site-info">
     <? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "footer2.html"); ?>
    </div><!-- .site-info -->
  </footer><!-- #footer -->
</div> <!-- /#page -->
